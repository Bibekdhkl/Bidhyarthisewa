          ...
          <div className="flex items-baseline justify-between border-b border-black-200 pb-6 pt-24">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm font-medium text-black-700 hover:text-black-900">
                    Sort
                    <ChevronDownIcon
              ...
              <button
                type="button"
                className="-m-2 ml-5 p-2 text-black-400 hover:text-black-500 sm:ml-7"
              >
          ...
          >
            <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
              <div className="flex items-center justify-between px-4">
                <h2 className="text-lg font-medium text-black-900">Filters</h2>
                <button
                  type="button"
              ...
              <form className="mt-4 border-t border-black-200">
                {filters?.map((section) => (
                  <Disclosure
                    as="div"
                    key={section.id}
                    className="border-t border-black-200 px-4 py-6"
                  >
                    {({ open }) => (
                      <>
            ...
            <>
              ...
              <Disclosure.Panel className="pt-6">
                <div className="space-y-4">
                  {section.options?.map ||
                    section.options.data.map((option, optionIdx) => (
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {status === "loading" ? (
            ...
            `}
                key={product.id}
              >
                <div className="group relative border-solid border-2 p-2 border-black-200">
                  <div className="min-h-60 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-black-200 lg:aspect-none group-hover:opacity-75 lg:h-60">
                    <img
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-sm block line-through font-medium text-black-400">
                        ${product.price}
                      </p>
                    </div>
                  </div>
