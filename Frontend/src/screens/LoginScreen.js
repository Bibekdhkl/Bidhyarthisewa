...
const LoginScreen = ({ location, history }) => {
  ...
  return (
    <FormContainer>
      <h1 style={{ textAlign: "center", fontWeight: 800, color: "black" }}>SIGN IN</h1>
      {error && <Message variant='danger'>{error}</Message>}
      {loading && <Loader />}
      <Form onSubmit={submitHandler} className='mt-5'>
        <Form.Group controlId='email' style={{ color: "black", fontWeight: 800 }}>
        ...
        <Form.Group controlId='password'>
          <Form.Label style={{ color: "black", fontWeight: 800 }}>Password </Form.Label>
          <Form.Control
            type='password'
        ...
        <Button type='submit' variant='primary' style={{fontWeight: 800 }}>
          Sign In
        </Button>
      </Form>{' '}
      <Row className='py-3'>
